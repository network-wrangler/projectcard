...
#   timestamp: 2024-04-22T20:38:28+00:00
...
class Dependencies(BaseModel):
    ...
    prerequisites: Annotated[
        Optional[List], Field(examples=['7th St E Road Diet'], title='Project Prerequisites')
    ] = None
    corequisites: Annotated[
        Optional[List], Field(examples=['7th St E Road Diet'], title='Project Co-requisites')
    ] = None
    conflicts: Annotated[
        Optional[List], Field(examples=['7th St E Road Diet'], title='Project Conflicts')
    ] = None
...
class Distance(BaseModel):
    __root__: Annotated[float, Field(examples=[93.08], ge=0.0, title='Distance')]
...
class LocationReferences(BaseModel):
    ...
    __root__: Annotated[List[LocationReference], Field(description='The Locationreferences Schema')]
...
class Point1(BaseModel):
    ...
    __root__: Annotated[List[Z], Field(description='The Point Schema', max_items=3, min_items=2)]
...
class TripId(BaseModel):
    __root__: Annotated[str, Field(description='ID for Individual trip a transit vehicle takes..')]
...
class TripShortName(BaseModel):
    __root__: Annotated[str, Field(description='Route short name, often something like `38X`.')]
...
class SelectRouteProperties(BaseModel):
    ...
    route_short_name: Annotated[Optional[List[RouteShortName]], Field(min_items=1)] = None
...
class MLLanes(BaseModel):
    __root__: Annotated[Lanes, Field(description='Lanes for a parallel managed lane facility.')]
...
class MLPrice(BaseModel):
    __root__: Annotated[Price, Field(description='Price for a parallel managed lane facility.')]
...
class Change(BaseModel):
    __root__: Union[Change1, Change2, Change3, Change4, Change5, Change6, Change7]
