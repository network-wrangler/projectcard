...
AllOf = Annotated[
    List[str],
    Field(description=['List fields where all are required for the data model to be valid.']),
]
...
AnyOf = Annotated[
    List[Union[str, AllOf]],
    Field(
        description=['List fields, AllOf where any are required for the data model to be valid.']
    ),
]
